...
const TOP_RATED_BOARD_ID = `top-rated`;
const MOST_COMMENTED_BOARD_ID = `most-commented`;
...
const createMoviesExtraBoard = (id, title) => {
  return (
...
// Top rated board
render(moviesContainer, createMoviesExtraBoard(TOP_RATED_BOARD_ID, `Top rated`), `beforeend`);
const topRatedBoard = moviesContainer.querySelector(`#${TOP_RATED_BOARD_ID}`);
...
render(moviesContainer, createMoviesExtraBoard(MOST_COMMENTED_BOARD_ID, `Most commented`), `beforeend`);
const mostCommentedBoard = moviesContainer.querySelector(`#${MOST_COMMENTED_BOARD_ID}`);
